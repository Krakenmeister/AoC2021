		...
		try {
			...
			for (int i=0; i<numbers.size(); i++) {
				for (int j=0; j<boards.size(); j++) {
					if (boards.get(j).get(0).get(0) != -1000) {
						...
						for (int k=0; k<10; k++) {
							if ((bingoCounts[k] == 5) && (boards.get(j).get(0).get(0) != -1000)) {
								numWinners++;
								if (numWinners == boards.size()) {
									...
									score *= numbers.get(i);
									System.out.println("Final bingo has been won! Final score = " + score);
									//for (int a=0; a<boards.size(); a++) {
									//	for (int b=0; b<5; b++) {
									//		for (int c=0; c<5; c++) {
									//			System.out.print(boards.get(j).get(b).get(c) + " ");
									//		}
									//		System.out.println();
									//	}
									//	System.out.println();
									...
									//System.out.println("Board " + j + " has won.");
									boards.get(j).get(0).set(0, -1000);
								}
							}
						}
					}
